...
public class ExpertAdapterForCatalog extends RecyclerView.Adapter<ExpertViewHolder> {

    private final ArrayList<Expert> experts;
    private final DatabaseReference rtdb;

    public ExpertAdapterForCatalog(ArrayList<Expert> experts) {
    ...
    public ExpertViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_form_expert_for_catalog, parent, false);
